        ...
        <section className="grid w-full grid-cols-1 gap-8 lg:grid-cols-2">
          <div className="hidden lg:flex lg:flex-col lg:justify-center">
            ...
            <p className="mt-4 max-w-md text-base text-white/65">
              Abre tu perfil, confirma tu correo y entra al mercado de predicciones dominicano con una experiencia premium.
            </p>
          </div>
          ...
          <div className="admin-card mx-auto w-full max-w-md p-6 sm:p-8">
            ...
            <p className="mt-6 text-sm text-white/65">
              Ya tienes cuenta?{" "}
              <Link href="/auth/login" className="font-semibold text-white underline decoration-white/40">
                Inicia sesion
              </Link>
            </p>
          </div>
